const CACHE='moa-world-v9-2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./app.part1.txt','./app.part2.txt','./app.part3.txt','./app.part4.txt','./app.part5.txt','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
